                ...
                <div className="border-gradient p-[3px] rounded-lg shadow-lg">
                    <div className="bg-black p-5 rounded-lg shadow-lg h-full w-full">
                        ...
                        <div className="mt-3 flex justify-center space-x-4">
                            <a href="https://github.com/DeveloperKubilay" className="p-2 bg-gray-900 hover:bg-gray-800 rounded-md transition-all transform hover:scale-105" title={t('socialLinks.github')}>
                            ...
                            <a href="https://www.youtube.com/@valancess" className="p-2 bg-gray-900 hover:bg-gray-800 rounded-md transition-all transform hover:scale-105" title={t('socialLinks.youtube')}>
                                <svg className="w-5 h-5 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 4-8 4z" />
                                </svg>
                            </a>
                            <a href="https://steamcommunity.com/id/valancess/" className="p-2 bg-gray-900 hover:bg-gray-800 rounded-md transition-all transform hover:scale-105" title={t('socialLinks.steam')}>
                                <svg className="w-5 h-5 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
